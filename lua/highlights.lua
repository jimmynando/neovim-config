...
-- Kaganawa-inspired syntax colors
vim.api.nvim_set_hl(0, "@keyword", { fg = "#f09bc2" })
vim.api.nvim_set_hl(0, "@keyword.return", { fg = "#ff6f91" })
vim.api.nvim_set_hl(0, "@string", { fg = "#bfe889" })
vim.api.nvim_set_hl(0, "@number", { fg = "#ffad5c" })
vim.api.nvim_set_hl(0, "@constant", { fg = "#ffad5c" })
vim.api.nvim_set_hl(0, "@function", { fg = "#91c2f5" })
vim.api.nvim_set_hl(0, "@function.call", { fg = "#91c2f5" })
vim.api.nvim_set_hl(0, "@type", { fg = "#5de0da" })
vim.api.nvim_set_hl(0, "@variable", { fg = "#e8e0d2" })
vim.api.nvim_set_hl(0, "@property", { fg = "#82ddb0" })
vim.api.nvim_set_hl(0, "@operator", { fg = "#d6ccc0" })
vim.api.nvim_set_hl(0, "@comment", { fg = "#918a84", italic = true })
vim.api.nvim_set_hl(0, "Directory", { fg = "#91c2f5" })
